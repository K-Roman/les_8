...
cprint('Общий простой грузовиков {}'.format(Truck.downtime), color ='yellow')
cprint('Общий простой погрузчиков {}'.format(AutoLoader.downtime), color ='yellow')